...
public class CalcularElImporteTotalDelEmpleadoQueMasHaVendidoUnProducto implements Query {
	...
	public Object execute(Object param) {
		...
		try {
			...
			String query = "SELECT v_in.ID_EMPLEADO, SUM(lv_in.NUM_UNIDADES * lv_in.PRECIO_UNIDADES) AS total_vendido "
					+ "FROM LINEAVENTA lv_in " + "JOIN VENTA v_in ON lv_in.ID_VENTA = v_in.ID "
					+ "WHERE lv_in.ID_PRODUCTO = ? AND v_in.ACTIVO = 1 " + "GROUP BY v_in.ID_EMPLEADO "
